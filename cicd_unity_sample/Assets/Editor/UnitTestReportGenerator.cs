...
public static class UnityTestReportGenerator
{
    ...
    {
        //LocalLogger.ShowLocalLog("CreateXmlReport : " + result + " -- " + reportPath);
       UnityEngine.Debug.Log("CreateXmlReport : " + result + " -- " + reportPath);
